...
module Crystal
  describe "Parser" do
    ...
    it_parses "foo &.block=(0)", Call.new("foo", block: Block.new([Var.new("__arg0")], Call.new(Var.new("__arg0"), "block=", Expressions.new([0.int32] of ASTNode))))
    it_parses "foo &.block = 0", Call.new("foo", block: Block.new([Var.new("__arg0")], Call.new(Var.new("__arg0"), "block=", 0.int32)))
    it_parses "foo &.block = (0)", Call.new("foo", block: Block.new([Var.new("__arg0")], Call.new(Var.new("__arg0"), "block=", Expressions.new([0.int32] of ASTNode))))
    it_parses "foo(&.y = (a.b || c))", Call.new("foo", block: Block.new([Var.new("__arg0")], Call.new(Var.new("__arg0"), "y=", Expressions.new([Or.new(Call.new(Call.new(nil, "a"), "b"), Call.new(nil, "c"))] of ASTNode))))
