...
module Crystal
  describe "Parser" do
    ...
    it_parses "def foo(var : self.class?); end", Def.new("foo", [Arg.new("var", restriction: Crystal::Union.new([Metaclass.new(Self.new), Path.global("Nil")] of ASTNode))])
    it_parses "def foo(var : Int.class?); end", Def.new("foo", [Arg.new("var", restriction: Crystal::Union.new([Metaclass.new("Int".path), Path.global("Nil")] of ASTNode))])
    ...
    it_parses "lib LibC; type A = B.class?; end", LibDef.new("LibC".path, [TypeDef.new("A", Crystal::Union.new([Metaclass.new("B".path), Path.global("Nil")] of ASTNode))] of ASTNode)
