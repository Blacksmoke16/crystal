...
module Crystal
  describe Crystal::Macros do
    ...
    describe "#flag?" do
      context "has the flag" do
        it "should return true" do
          assert_macro "", %({{flag?(:foo)}}), [] of ASTNode, %(true), flags: "foo"
        end
      end

      context "does not have the flag" do
    ...
    describe ArrayLiteral do
      ...
      describe "#empty?" do
        context "with an empty ArrayLiteral" do
          it "returns true" do
            assert_macro "", %({{([] of ASTNode).empty?}}), [] of ASTNode, "true"
          end
        end

        context "with a non-empty ArrayLiteral" do
          it "returns true" do
      ...
      describe "#first" do
        context "with an empty array" do
          it "should return nil" do
            assert_macro "", %({{([] of ASTNode).first}}), [] of ASTNode, "nil"
          end
        end
      ...
      describe "#last" do
        context "with an empty array" do
          it "should return nil" do
            assert_macro "", %({{([] of ASTNode).last}}), [] of ASTNode, "nil"
          end
        end
      ...
      describe "#size" do
        it "returns the size of the `ArrayLiteral`" do
      ...
      describe "#splat" do
        context "with numbers" do
          describe "it splats the array" do
      ...
      describe "#type" do
        it "returns the type of the ArrayLiteral" do
    ...
    # No methods to test
    describe ImplicitObj do
    end

    describe InstanceVar do
      describe "#name" do
        it "returns correctly" do
    ...
    describe NamedTupleLiteral do
      ...
      describe "#map" do
        context "without any arguments" do
          it "should return correctly" do
            assert_macro "", %({{{a: 1, b: 2}.map { true } }}), [] of ASTNode, "[true, true]"
          end
        end

        context "with only the key argument" do
          it "should return correctly" do
            assert_macro "", %({{{a: 1, b: 2}.map { |k| k.stringify } }}), [] of ASTNode, %(["a", "b"])
          end
        end

        context "with only the value argument" do
          it "should return correctly" do
            assert_macro "", %({{{a: 1, b: 2}.map { |_, v| v } }}), [] of ASTNode, %([1, 2])
          end
        end
      ...
      describe "#double_splat" do
        context "with the shortcut syntax" do
          it "should splat correctly" do
            assert_macro "", %({{**{a: 1, "foo bar": 2}}}), [] of ASTNode, %(a: 1, "foo bar": 2)
          end
        end

        context "without shortcut method" do
          it "should splat correctly" do
    ...
    describe Splat do
      describe "#exp" do
        it "returns splatted expresssion" do
    ...
    describe Union do
      it "executes types" do
        assert_macro "x", %({{x.types}}), [Union.new(["Int32".path, "String".path] of ASTNode)] of ASTNode, "[Int32, String]"
      end

      it "executes resolve" do
        assert_macro "x", %({{x.resolve}}), [Union.new(["Int32".path, "String".path] of ASTNode)] of ASTNode, "(Int32 | String)"
      end

      it "executes resolve?" do
        assert_macro "x", %({{x.resolve?}}), [Union.new(["Int32".path, "String".path] of ASTNode)] of ASTNode, "(Int32 | String)"
        assert_macro "x", %({{x.resolve?}}), [Union.new(["Int32".path, "Unknown".path] of ASTNode)] of ASTNode, "nil"
      end
    end

    describe VisibilityModifier do
