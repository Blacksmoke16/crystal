module Crystal
  ...
  class Assign < ASTNode
    ...
    def initialize(@target, @value, @parsed_annotations : Array(Annotation)? = nil)
    end
    ...
    def clone_without_location
      Assign.new(@target.clone, @value.clone, @parsed_annotations.clone)
    end

    def_equals_and_hash @target, @value, @parsed_annotations
  end
  ...
  class Def < ASTNode
    ...
    def initialize(
      @name, @args = [] of Arg, body = nil, @receiver = nil, @block_arg = nil, @return_type = nil, @macro_def = false,
      @block_arity = nil, @abstract = false, @splat_index = nil, @double_splat = nil, @free_vars = nil, @parsed_annotations : Array(Annotation)? = nil
    )
      @body = Expressions.from body
    end
    ...
    def clone_without_location
      a_def = Def.new(@name, @args.clone, @body.clone, @receiver.clone, @block_arg.clone, @return_type.clone, @macro_def, @block_arity, @abstract, @splat_index, @double_splat.clone, @free_vars, @parsed_annotations.clone)
    ...
    def_equals_and_hash @name, @args, @body, @receiver, @block_arg, @return_type, @macro_def, @block_arity, @abstract, @splat_index, @double_splat, @parsed_annotations
  ...
  class Macro < ASTNode
    ...
    def initialize(@name, @args = [] of Arg, @body = Nop.new, @block_arg = nil, @splat_index = nil, @double_splat = nil, @parsed_annotations : Array(Annotation)? = nil)
    end
    ...
    def clone_without_location
      m = Macro.new(@name, @args.clone, @body.clone, @block_arg.clone, @splat_index, @double_splat.clone, @parsed_annotations.clone)
      m.name_location = name_location
      m
    end

    def_equals_and_hash @name, @args, @body, @block_arg, @splat_index, @double_splat, @parsed_annotations
  end
  ...
  class ClassDef < ASTNode
    ...
    def initialize(@name, body = nil, @superclass = nil, @type_vars = nil, @abstract = false, @struct = false, @splat_index = nil, @parsed_annotations : Array(Annotation)? = nil)
      @body = Expressions.from body
    end
    ...
    def clone_without_location
      clone = ClassDef.new(@name, @body.clone, @superclass.clone, @type_vars.clone, @abstract, @struct, @splat_index, @parsed_annotations.clone)
      clone.name_location = name_location
      clone
    end

    def_equals_and_hash @name, @body, @superclass, @type_vars, @abstract, @struct, @splat_index, @parsed_annotations
  end
  ...
  class ModuleDef < ASTNode
    ...
    def initialize(@name, body = nil, @type_vars = nil, @splat_index = nil, @parsed_annotations : Array(Annotation)? = nil)
      @body = Expressions.from body
    end
    ...
    def clone_without_location
      clone = ModuleDef.new(@name, @body.clone, @type_vars.clone, @splat_index, @parsed_annotations.clone)
      clone.name_location = name_location
      clone
    end

    def_equals_and_hash @name, @body, @type_vars, @splat_index, @parsed_annotations
  end
  ...
  class AnnotationDef < ASTNode
    ...
    def initialize(@name, @parsed_annotations : Array(Annotation)? = nil)
    end
    ...
    def clone_without_location
      clone = AnnotationDef.new(@name, @parsed_annotations.clone)
      clone.name_location = name_location
      clone
    end

    def_equals_and_hash @name, @parsed_annotations
  end
  ...
  class LibDef < ASTNode
    ...
    def initialize(@name, body = nil, @parsed_annotations : Array(Annotation)? = nil)
      @body = Expressions.from body
    end
    ...
    def clone_without_location
      clone = LibDef.new(@name, @body.clone, @parsed_annotations.clone)
      clone.name_location = name_location
      clone
    end

    def_equals_and_hash @name, @body, @parsed_annotations
  end
  ...
  class FunDef < ASTNode
    ...
    def initialize(@name, @args = [] of Arg, @return_type = nil, @varargs = false, @body = nil, @real_name = name, @parsed_annotations : Array(Annotation)? = nil)
    end
    ...
    def clone_without_location
      clone = FunDef.new(@name, @args.clone, @return_type.clone, @varargs, @body.clone, @real_name, @parsed_annotations.clone)
      clone.name_location = name_location
      clone
    end
    ...
    def_equals_and_hash @name, @args, @return_type, @varargs, @body, @real_name, @parsed_annotations
  end
  ...
  class CStructOrUnionDef < ASTNode
    ...
    def initialize(@name, body = nil, @union = false, @parsed_annotations : Array(Annotation)? = nil)
      @body = Expressions.from(body)
    end
    ...
    def clone_without_location
      CStructOrUnionDef.new(@name, @body.clone, @union, @parsed_annotations.clone)
    end

    def_equals_and_hash @name, @union, @body, @parsed_annotations
  end
  ...
  class Alias < ASTNode
    ...
    def initialize(@name : Path, @value : ASTNode, @parsed_annotations : Array(Annotation)? = nil)
    end
    ...
    def clone_without_location
      Alias.new(@name.clone, @value.clone, @parsed_annotations.clone)
    end

    def_equals_and_hash @name, @value, @parsed_annotations
  end
